...
PETSC_DIR=/Users/Austin/Documents/C_Progs/petsc-3.11.2/arch-darwin-c-opt
...
csd: 
	...
	gcc -O3 $(LFlags)   -o csd grid_update.o constants.o initialize.o csd_main.o ion_channel.o array_function.o update_solution.o misc_print_plot.o $(Linker) -lpetsc -lf2clapack -lf2cblas -lX11 -ldl

	rm csd_main.o constants.o grid_update.o initialize.o ion_channel.o array_function.o update_solution.o misc_print_plot.o
